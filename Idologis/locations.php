...
<html> 
    ...
    <body>
        <div class="banner">
            ...
            <div class="content">
                <h2>Voici nos locations :</h2>
                <?php
                // Requête SQL pour récupérer toutes les locations
                ...
                if ($stmt->rowCount() > 0) {
                    ...
                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                        ...
                        echo "<td><a href='bien.php?reference=" . $row['Reference'] . "&type=l'>Voir</a></td>";
                        echo "</tr>";
                    }
